...
func NewRuntimeHistory(events paymentapplication.EventLog, jobs RuntimeJobAuditReader, hooks webhookapplication.DeliveryAuditReader) (*RuntimeHistory, error) {
	if events == nil {
	...
	return &RuntimeHistory{events: events, jobs: jobs, hooks: hooks}, nil
}
